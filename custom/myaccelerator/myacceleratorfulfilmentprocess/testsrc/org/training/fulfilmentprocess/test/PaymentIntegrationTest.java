...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/myacceleratorfulfilmentprocess/test/myacceleratorfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/myacceleratorfulfilmentprocess/test/myacceleratorfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/myacceleratorfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/myacceleratorfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/myacceleratorfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/myacceleratorfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/myacceleratorfulfilmentprocess/test/myacceleratorfulfilmentprocess-spring-testcleanup.xml"));
