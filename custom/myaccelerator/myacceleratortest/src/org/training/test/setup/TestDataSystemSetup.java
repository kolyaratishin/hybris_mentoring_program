...
import org.training.test.constants.MyacceleratorTestConstants;
 ...
 */
@SystemSetup(extension = MyacceleratorTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/myacceleratortest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/myacceleratortest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/myacceleratortest/import/cstickets.impex");
			...
			importImpexFile(context, "/myacceleratortest/import/csquotes.impex");
		}
	}
}
