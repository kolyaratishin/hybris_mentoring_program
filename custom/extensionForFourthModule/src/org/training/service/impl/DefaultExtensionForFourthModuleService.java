...
public class DefaultExtensionForFourthModuleService implements ExtensionForFourthModuleService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExtensionForFourthModuleService.class);
	...
	{
		return DefaultExtensionForFourthModuleService.class.getResourceAsStream("/extensionForFourthModule/sap-hybris-platform.png");
	}
