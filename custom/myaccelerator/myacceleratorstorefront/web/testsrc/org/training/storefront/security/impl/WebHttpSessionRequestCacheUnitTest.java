...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/myacceleratorstorefront/electronics/en",
						"https://electronics.local:9002/myacceleratorstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/myacceleratorstorefront/electronics/en",
						"https://electronics.local:9002/myacceleratorstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/myacceleratorstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/myacceleratorstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/myacceleratorstorefront/electronics/en",
						"https://electronics.local:9002/myacceleratorstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/myacceleratorstorefront",
						"https://electronics.local:9002/myacceleratorstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/myacceleratorstorefront",
						"https://electronics.local:9002/myacceleratorstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/myacceleratorstorefront/electronics/en",
						"https://electronics.local:9002/myacceleratorstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
