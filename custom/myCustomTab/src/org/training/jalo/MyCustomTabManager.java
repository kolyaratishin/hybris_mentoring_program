 ...
 */
public class MyCustomTabManager extends GeneratedMyCustomTabManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MyCustomTabManager.class.getName());
	 ...
	 */
	public static MyCustomTabManager getInstance()
	{
		return (MyCustomTabManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MyCustomTabConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyCustomTabManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MyCustomTabManager called.");
		}
	}
