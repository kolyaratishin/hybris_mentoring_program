...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "mywebcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "mywebcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "mywebcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "mywebcommercewebservices.v2.description";
	private static final String TITLE = "mywebcommercewebservices.v2.title";
	private static final String VERSION = "mywebcommercewebservices.v2.version";
	private static final String LICENSE = "mywebcommercewebservices.v2.license";
	private static final String LICENSE_URL = "mywebcommercewebservices.v2.license.url";
