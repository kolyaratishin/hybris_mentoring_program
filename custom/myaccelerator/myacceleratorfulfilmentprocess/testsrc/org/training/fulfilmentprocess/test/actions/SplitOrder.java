...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MyacceleratorFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MyacceleratorFulfilmentProcessConstants.PARENT_PROCESS);
