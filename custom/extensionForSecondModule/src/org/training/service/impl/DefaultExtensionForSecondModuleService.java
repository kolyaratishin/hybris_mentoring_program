...
public class DefaultExtensionForSecondModuleService implements ExtensionForSecondModuleService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExtensionForSecondModuleService.class);
	...
	{
		return DefaultExtensionForSecondModuleService.class.getResourceAsStream("/extensionForSecondModule/sap-hybris-platform.png");
	}
