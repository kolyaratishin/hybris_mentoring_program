...
public class DefaultExtensionForThirdModuleService implements ExtensionForThirdModuleService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExtensionForThirdModuleService.class);
	...
	{
		return DefaultExtensionForThirdModuleService.class.getResourceAsStream("/extensionForThirdModule/sap-hybris-platform.png");
	}
