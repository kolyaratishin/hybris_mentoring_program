...
/**
 * Global class for all MyacceleratorCore constants. You can add global constants for your extension into this class.
 */
public final class MyacceleratorCoreConstants extends GeneratedMyacceleratorCoreConstants
{
	public static final String EXTENSIONNAME = "myacceleratorcore";


	private MyacceleratorCoreConstants()
	{
		//empty
	}
